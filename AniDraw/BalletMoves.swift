...
struct BalletMoves {
    static let AllMoves: [DanceMove] = [BalletHop2, BalletKick4, BalletJump3]
    static let BalletHop2 = DanceMove(
        keyframes:
        [
            Keyframe(
                time: 0.5,
    ...
    static let BalletKick4 = DanceMove(
        keyframes:
        [
            Keyframe(
                time: 0.5,
    ...
    static let BalletJump3 = DanceMove(
        keyframes:
        [
            Keyframe( 
                time: 0.25, 
